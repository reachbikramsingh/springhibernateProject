...
import com.bikram.model.StudentCredential;
import com.bikram.service.StudentService;
...
public class MyController {
	...
	public ModelAndView loginSuccess(@Valid @ModelAttribute("studentCredential") StudentCredential studentCredential,
		...
		ModelAndView modelAndView = new ModelAndView("welcome");
		Student student = getStudentService().validateStudentCredential(studentCredential.getEmail(),
				studentCredential.getPassword());
		if (student != null) {
			modelAndView.addObject("student", student);
			return modelAndView;
		} else {
	...
	public void headerMessage(Model model) {
		model.addAttribute("headerMessage", "lets go with actions..");
